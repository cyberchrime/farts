...
async def run_test(dut):
    ...
    axis_tdata_raw = 0xfedcba9876543210
    axis_tdata_big = (axis_tdata_raw).to_bytes(8, byteorder='little')
    #axis_tdata_little = (axis_tdata_raw).to_bytes(8, byteorder='little')
    ...
    dut.prepend_value.value = axis_tdata_raw
    dut.start_packet.value = 0
    ...
    assert data.tdata == axis_tdata_big + axis_tdata
